...
<h1 align="center">SignIn</h1>
  <div style="display: flex;">
      ...
      <div style="width:40%;height:400px;margin-top: 130px" >
        <h2 style="font-family: MS Sans Serif;font-weight: bold;text-decoration: underline;">Login as DOCTOR</h2>
       <form action="doctorloginscript.php" method="post">
        <fieldset style="color: solid red">
          <legend style="color: solid red"><b >Enter details</b></legend><br>
              <table>
                  ...
                  <tr>
                    <td>Contact:</td>
                    <td><input type="password" /*pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[~!@#$%^&*()_-]).{6,10}" */ placeholder="contact" name="contact" size="25" 
                  ...
                  <tr>
                    <td><input value="Login" type="submit" name="sign_doctor" namstyle="font-size:20px;margin:10px; border-radius: 5px;" ></td>
